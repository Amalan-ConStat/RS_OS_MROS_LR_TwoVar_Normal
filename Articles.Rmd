...
M1_Identical_r0<-rbind(cbind.data.frame(Covariate="Data Model: x\u2081, x\u2082",Metric="Model Information",
                       ...
                       cbind.data.frame(Covariate="Data Model: x\u2081, x\u2082",Metric="MSE for MLE",
                                        All_MSE_MLE),
                       cbind.data.frame(Covariate="Data Model: x\u2081, x\u2082",Metric="Accuracy",
                                        All_ACC))
...
M2_Identical_r0<-rbind(cbind.data.frame(Covariate="Data Model: x\u2081, x\u2082, (x\u2081)\u00B2",Metric="Model Information",
                       ...
                       cbind.data.frame(Covariate="Data Model: x\u2081, x\u2082, (x\u2081)\u00B2",Metric="MSE for MLE",
                                        All_MSE_MLE),
                       cbind.data.frame(Covariate="Data Model: x\u2081, x\u2082, (x\u2081)\u00B2",Metric="Accuracy",
                                        All_ACC))
...
Identical_ro[Identical_ro$Metric=="Accuracy" & Identical_ro$Model %in% Selected_Models_mMSE,] %>%
  ggplot(.,aes(x=Subsample_Size,y=`Estimated Values`,color=Model,linetype=Model,shape=Model))+
  scale_x_continuous(labels = unique(Identical_ro$Subsample_Size),
                     breaks = unique(Identical_ro$Subsample_Size))+
  geom_point(size=1.25)+geom_line(size=0.75)+
...
Identical_ro[Identical_ro$Metric=="Accuracy" & Identical_ro$Model %in% Selected_Models_mVc,] %>%
  ggplot(.,aes(x=Subsample_Size,y=`Estimated Values`,color=Model,linetype=Model,shape=Model))+
  scale_x_continuous(labels = unique(Identical_ro$Subsample_Size),
                     breaks = unique(Identical_ro$Subsample_Size))+
  geom_point(size=1.25)+geom_line(size=0.75)+
...
# ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
#   ggexport(filename = here("Article_Plots","SMSE_MI_LR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 16)
# ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>%
#   ggexport(filename = here("Article_Plots","SMSE_MI_LR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 16)
ggarrange(p3,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_MI_LR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
ggarrange(p4,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_MI_LR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","ACCURACY_LR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","ACCURACY_LR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)
ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_LR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_LR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)

ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
  ggsave(filename = here("Article_Plots","SMSE_MI_LR_TV_Nor_mMSE.eps"),device="eps",dpi=300,width = 12,height = 16)
ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>% 
  ggsave(filename = here("Article_Plots","SMSE_MI_LR_TV_Nor_mVc.eps"),device="eps",dpi=300,width = 12,height = 16)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggsave(filename = here("Article_Plots","ACCURACY_LR_TV_Nor_mMSE.eps"),device="eps",dpi=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggsave(filename = here("Article_Plots","ACCURACY_LR_TV_Nor_mVc.eps"),device="eps",dpi=300,width = 12,height = 12)
ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_LR_TV_Nor_mMSE.eps"),res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_LR_TV_Nor_mVc.eps"),res=300,width = 12,height = 12)
```