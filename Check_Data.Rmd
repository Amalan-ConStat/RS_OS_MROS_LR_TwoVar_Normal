...
glm(Y~.-1,data=as.data.frame(Original_Data),family="binomial")->Model_1
...
colnames(Original_Data)<-c("Y","X0",paste0("X",1:no_of_Variables),
                           paste0("X",1:no_of_Variables,"^2"))
glm(Y~.-1,data=as.data.frame(Original_Data),family="binomial")->Model_2
...
colnames(Original_Data)<-c("Y","X0",paste0("X",1:no_of_Variables),
                           paste0("X",1:no_of_Variables,"^2"))
glm(Y~.-1,data=as.data.frame(Original_Data),family="binomial")->Model_3
...
colnames(Original_Data)<-c("Y","X0",paste0("X",1:no_of_Variables),
                           paste0("X",1:no_of_Variables,"^2"))
glm(Y~.-1,data=as.data.frame(Original_Data),family="binomial")->Model_4
