...
# OSMAC
load(here("Identical_r0","Summary","Classical","Model_1","Data","Efficiency","No_Correlated_Covariate_OSMAC_r1.RData"))
...
# OSMAC
load(here("Identical_r0","Summary","Classical","Model_2","Data","Efficiency","No_Correlated_Covariate_OSMAC_r1.RData"))
remove_stuff<-c(paste0("Assumed New ",1:3))
All_MSE<-All_MSE[!(All_MSE$Model %in% remove_stuff),]
All_Info<-All_Info[!(All_Info$Model %in% remove_stuff),]
...
# OSMAC
load(here("Identical_r0","Summary","Classical","Model_3","Data","Efficiency","No_Correlated_Covariate_OSMAC_r1.RData"))
remove_stuff<-c(paste0("Assumed New ",1:3))
All_MSE<-All_MSE[!(All_MSE$Model %in% remove_stuff),]
All_Info<-All_Info[!(All_Info$Model %in% remove_stuff),]
All_ACC<-Accuracy_Data[!(Accuracy_Data$Model %in% remove_stuff),]
...
# OSMAC
load(here("Identical_r0","Summary","Classical","Model_4","Data","Efficiency","No_Correlated_Covariate_OSMAC_r1.RData"))
remove_stuff<-c(paste0("Assumed New ",1:3))
All_MSE<-All_MSE[!(All_MSE$Model %in% remove_stuff),]
All_Info<-All_Info[!(All_Info$Model %in% remove_stuff),]
All_ACC<-Accuracy_Data[!(Accuracy_Data$Model %in% remove_stuff),]
...
Identical_ro[Identical_ro$Metric=="Model Information" & Identical_ro$Model %in% Selected_Models_mMSE,] %>%
  ...
  xlab(paste0(expression(r[0],' + ',r[1],'=1000 and ',r[0])))+
...
ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
  ggexport(filename = "r1_SMSE_MI_LR_TV_Exp_mMSE.pdf",res=300,width = 12,height = 16)
ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>%
  ggexport(filename = "r1_SMSE_MI_LR_TV_Exp_mVc.pdf",res=300,width = 12,height = 16)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = "r1_ACCURACY_LR_TV_Exp_mMSE.pdf",res=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = "r1_ACCURACY_LR_TV_Exp_mVc.pdf",res=300,width = 12,height = 12)


ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
  ggsave(filename = "r1_SMSE_MI_LR_TV_Exp_mMSE.eps",device="eps",dpi=300,width = 12,height = 16)
ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>% 
  ggsave(filename = "r1_SMSE_MI_LR_TV_Exp_mVc.eps",device="eps",dpi=300,width = 12,height = 16)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggsave(filename = "r1_ACCURACY_LR_TV_Exp_mMSE.eps",device="eps",dpi=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggsave(filename = "r1_ACCURACY_LR_TV_Exp_mVc.eps",device="eps",dpi=300,width = 12,height = 12)
```