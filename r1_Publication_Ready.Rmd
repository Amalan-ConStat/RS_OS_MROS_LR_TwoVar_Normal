...
for (i in 1:length(Old_Labels)) 
{
  ...
  All_MSE_MLE$Model[All_MSE_MLE$Model==Old_Labels[i] & All_Bias$Type == "mMSE"] <-paste0("OSMAC mMSE ",New_Labels[i])
...
for (i in 1:length(Old_Labels)) 
{
  ...
  All_MSE_MLE$Model[All_MSE_MLE$Model==Old_Labels[i] & All_Bias$Type == "mVc"] <-paste0("OSMAC mVc ",New_Labels[i])
...
# All elements
All_Bias<-rbind(OSMAC_mMSE_Bias[,!(colnames(OSMAC_mMSE_Bias) %in% "Type")],
                OSMAC_mVc_Bias[,!(colnames(OSMAC_mVc_Bias) %in% "Type")])
All_EMSE<-rbind(OSMAC_mMSE_EMSE[,!(colnames(OSMAC_mMSE_EMSE) %in% "Type")],
                OSMAC_mVc_EMSE[,!(colnames(OSMAC_mVc_EMSE) %in% "Type")])
All_MSE<-rbind(OSMAC_mMSE_MSE[,!(colnames(OSMAC_mMSE_MSE) %in% "Type")],
               OSMAC_mVc_MSE[,!(colnames(OSMAC_mVc_MSE) %in% "Type")])
All_MSE_MLE<-rbind(OSMAC_mMSE_MSE_MLE[,!(colnames(OSMAC_mMSE_MSE_MLE) %in% "Type")],
                   OSMAC_mVc_MSE_MLE[,!(colnames(OSMAC_mVc_MSE_MLE) %in% "Type")])
All_Info<-rbind(OSMAC_mMSE_Info[,!(colnames(OSMAC_mMSE_Info) %in% "Type")],
                OSMAC_mVc_Info[,!(colnames(OSMAC_mVc_Info) %in% "Type")])
All_VAR<-rbind(OSMAC_mMSE_VAR[,!(colnames(OSMAC_mMSE_VAR) %in% "Type")],
               OSMAC_mVc_VAR[,!(colnames(OSMAC_mVc_VAR) %in% "Type")])
All_ACC<-rbind(OSMAC_mMSE_ACC[,!(colnames(OSMAC_mMSE_ACC) %in% "Type")],
...
All_Bias$Model<-factor(All_Bias$Model,levels=c("OSMAC mMSE RM","OSMAC mVc RM",
                                               "OSMAC mMSE AM 1","OSMAC mVc AM 1",
                                               "OSMAC mMSE AM 2","OSMAC mVc AM 2",
                                               "OSMAC mMSE AM 3","OSMAC mVc AM 3",
                                               "OSMAC mMSE MF","OSMAC mVc MF"))
All_EMSE$Model<-factor(All_EMSE$Model,levels=c("OSMAC mMSE RM","OSMAC mVc RM",
                                               "OSMAC mMSE AM 1","OSMAC mVc AM 1",
                                               "OSMAC mMSE AM 2","OSMAC mVc AM 2",
                                               "OSMAC mMSE AM 3","OSMAC mVc AM 3",
                                               "OSMAC mMSE MF","OSMAC mVc MF"))
All_Info$Model<-factor(All_Info$Model,levels=c("OSMAC mMSE RM","OSMAC mVc RM",
                                               "OSMAC mMSE AM 1","OSMAC mVc AM 1",
                                               "OSMAC mMSE AM 2","OSMAC mVc AM 2",
                                               "OSMAC mMSE AM 3","OSMAC mVc AM 3",
                                               "OSMAC mMSE MF","OSMAC mVc MF"))
All_MSE$Model<-factor(All_MSE$Model,levels=c("OSMAC mMSE RM","OSMAC mVc RM",
                                             "OSMAC mMSE AM 1","OSMAC mVc AM 1",
                                             "OSMAC mMSE AM 2","OSMAC mVc AM 2",
                                             "OSMAC mMSE AM 3","OSMAC mVc AM 3",
                                             "OSMAC mMSE MF","OSMAC mVc MF"))
All_MSE_MLE$Model<-factor(All_MSE_MLE$Model,levels=c("OSMAC mMSE RM","OSMAC mVc RM",
                                                     "OSMAC mMSE AM 1","OSMAC mVc AM 1",
                                                     "OSMAC mMSE AM 2","OSMAC mVc AM 2",
                                                     "OSMAC mMSE AM 3","OSMAC mVc AM 3",
                                                     "OSMAC mMSE MF","OSMAC mVc MF"))
All_VAR$Model<-factor(All_VAR$Model,levels=c("OSMAC mMSE RM","OSMAC mVc RM",
                                             "OSMAC mMSE AM 1","OSMAC mVc AM 1",
                                             "OSMAC mMSE AM 2","OSMAC mVc AM 2",
                                             "OSMAC mMSE AM 3","OSMAC mVc AM 3",
                                             "OSMAC mMSE MF","OSMAC mVc MF"))
All_ACC$Model<-factor(All_ACC$Model,levels=c("OSMAC mMSE RM","OSMAC mVc RM",
                                             "OSMAC mMSE AM 1","OSMAC mVc AM 1",
                                             "OSMAC mMSE AM 2","OSMAC mVc AM 2",
                                             "OSMAC mMSE AM 3","OSMAC mVc AM 3",
                                             "OSMAC mMSE MF","OSMAC mVc MF"))
...
# mMSE models Colors
Selected_mMSE<-c("OSMAC mMSE RM",
                 "OSMAC mMSE AM 1","OSMAC mMSE AM 2","OSMAC mMSE AM 3",
                 "OSMAC mMSE MF")
Colors_mMSE<-c("#FFC4D8", 
               "#E28490","#BB2C3E","#55141C", 
               "#DDCC77")
# mvc models
Selected_mVc<-c("OSMAC mVc RM",
